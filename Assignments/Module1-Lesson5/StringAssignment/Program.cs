using static StringAssignment.StringExtensions;
...
int wordCount = text.CountWordsInString();
Console.WriteLine($"{wordCount} words in string");

int sentenceCount = text.CountSentences();
Console.WriteLine($"{sentenceCount} sentences in string");

int encapsulationCount = text.CountOccurrences("encapsulation");
Console.WriteLine($"Encapsulation appears {encapsulationCount} times in string");

string reversedWordsInString = text.ReverseWordsInString();
Console.WriteLine($"Reversed words in string: {reversedWordsInString}");

string reversedCharactersInString = text.ReverseCharactersInString();
Console.WriteLine($"Reversed characters in string: {reversedCharactersInString}");

string updatedText = text.Replace("object-oriented programming", "OOP");
Console.WriteLine($"Replaced words: {updatedText}");
